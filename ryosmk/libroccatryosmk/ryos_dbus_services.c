...
gboolean ryos_dbus_emit_profile_data_changed_outside(DBusGProxy *proxy, guint profile_index) {
	return dbus_roccat_call_y(proxy, org_roccat_Ryosmk_profile_data_changed_outside, profile_index);
}

gboolean ryos_dbus_emit_profile_data_changed_outside_instant(guint profile_index) {
	DBusGProxy *proxy;
	gboolean retval;
	...
	retval = ryos_dbus_emit_profile_data_changed_outside(proxy, profile_index);
	dbus_roccat_proxy_free(proxy);
	return retval;
}

gboolean ryos_dbus_emit_profile_changed_outside(DBusGProxy *proxy, guint profile_index) {
	return dbus_roccat_call_y(proxy, org_roccat_Ryosmk_profile_changed_outside, profile_index);
}

gboolean ryos_dbus_emit_profile_changed_outside_instant(guint profile_index) {
	DBusGProxy *proxy;
	gboolean retval;
	...
	retval = ryos_dbus_emit_profile_changed_outside(proxy, profile_index);
	dbus_roccat_proxy_free(proxy);
	return retval;
}
