...
static gboolean konextd_dbus_server_cb_talk_easyshift(KonextdDBusServer *object, guchar state, GError **error);
static gboolean konextd_dbus_server_cb_talk_easyshift_lock(KonextdDBusServer *object, guchar state, GError **error);
static gboolean konextd_dbus_server_cb_talk_easyaim(KonextdDBusServer *object, guchar state, GError **error);
static gboolean konextd_dbus_server_cb_talkfx_set_led_rgb(KonextdDBusServer *object, guint32 effect, guint32 ambient_color, guint32 event_color, GError **error);
static gboolean konextd_dbus_server_cb_talkfx_restore_led_rgb(KonextdDBusServer *object, GError **error);
static gboolean konextd_dbus_server_cb_gfx_set_led_rgb(KonextdDBusServer *object, guchar index, guint32 color, GError **error);
static gboolean konextd_dbus_server_cb_gfx_get_led_rgb(KonextdDBusServer *object, guchar index, guint32 *color, GError **error);
static gboolean konextd_dbus_server_cb_gfx_update(KonextdDBusServer *object, GError **error);
static gboolean konextd_dbus_server_cb_open_gui(KonextdDBusServer *object, GError **error);
static gboolean konextd_dbus_server_cb_profile_changed_outside(KonextdDBusServer *object, guchar number, GError **error);
static gboolean konextd_dbus_server_cb_profile_data_changed_outside(KonextdDBusServer *object, guchar number, GError **error);
static gboolean konextd_dbus_server_cb_configuration_changed_outside(KonextdDBusServer *object, GError **error);

#include "konextd_dbus_server_glue.h"

#define KONEXTD_DBUS_SERVER_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), TYPE_KONEXTD_DBUS_SERVER, KonextdDBusServerClass))
#define IS_KONEXTD_DBUS_SERVER_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), TYPE_KONEXTD_DBUS_SERVER))
#define KONEXTD_DBUS_SERVER_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), TYPE_KONEXTD_DBUS_SERVER, KonextdDBusServerClass))

typedef struct _KonextdDBusServerClass KonextdDBusServerClass;

struct _KonextdDBusServerClass {
	GObjectClass parent;
};

G_DEFINE_TYPE(KonextdDBusServer, konextd_dbus_server, G_TYPE_OBJECT);
...
static void konextd_dbus_server_finalize(GObject *object) {
	G_OBJECT_CLASS(konextd_dbus_server_parent_class)->finalize(object);
}

static void konextd_dbus_server_class_init(KonextdDBusServerClass *klass) {
	GObjectClass *object_class;
	object_class = G_OBJECT_CLASS(klass);
	object_class->finalize = konextd_dbus_server_finalize;
...
static void konextd_dbus_server_init(KonextdDBusServer *object) {}
...
static gboolean konextd_dbus_server_cb_talkfx_set_led_rgb(KonextdDBusServer *object,
